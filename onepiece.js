    ...
    },
{
    ...
    },
    {
        ...
        "gender": "Male",
        "affiliation": "Kozuki Clan",
        "devilFruit": "Uo Uo no Mi, Model: Seiryu (Artificial)",
        "haki": "Unknown",
        "bounty": "None",
        "height": "Unknown",
        "origin": "Wano",
    ...
    },
    {
        "name": "Carrot",
        "gender": "Female",
        "affiliation": "Minks / Straw Hat Pirates (temporary)",
        "devilFruit": "None",
        "haki": "None",
        "bounty": "Unknown",
        "height": "Unknown",
    ...
    },
    {
        "name": "Sengoku",
        "gender": "Male",
        "affiliation": "Marines (former Fleet Admiral)",
    ...
    },
    {
        "name": "Monkey D. Garp",
        "gender": "Male",
        "affiliation": "Marines (Vice Admiral)",
        "devilFruit": "None",
        "haki": "Observation, Armament, Conqueror",
        "bounty": "None",
        "height": "Unknown",
    ...
    },
    {
        "name": "Inuarashi",
        "gender": "Male",
        "affiliation": "Minks / Akazaya Nine",
        "devilFruit": "None",
        "haki": "Observation, Armament",
        "bounty": "Unknown",
        "height": "Unknown",
    ...
    },
    {
        "name": "Kanjuro",
        "gender": "Male",
        "affiliation": "Akazaya Nine (former)",
    ...
    },
    {
        "name": "Izo",
        "gender": "Male",
        "affiliation": "Whitebeard Pirates / Akazaya Nine",
        "devilFruit": "None",
        "haki": "Observation, Armament",
        "bounty": "Unknown",
        "height": "Unknown",
    ...
    },
    {
        ...
        "gender": "Male",
        "affiliation": "Blackbeard Pirates",
        "devilFruit": "None (Riki-Riki no Mi in manga)",
        "haki": "Observation, Armament",
        "bounty": "Unknown",
        "height": "Unknown",
        "origin": "Unknown",
...
const arcOrder = {
    ...
    "Dressrosa": 21,
    "Zou":22,
    "Whole Cake Island": 23,
    "Wano": 24,
    "Egghead": 25
};

/* ==========================================
   ONE PIECE CHARACTER GUESS
   PHASE 1
========================================== */
...
const animeKey = urlParams.get("anime");
...
function updateOPBestStreak(current){

    const best =

    getOPStat(
        "onepiece_best_streak"
    );
...
console.log("One Piece Story Ready");
...
async function submitGuess(){
    ...
    row.innerHTML=`
        ...
        <td>
            ...
            <div class="${compare(character.devilFruit,secretCharacter.devilFruit)}">
        ...
        <td>
            ...
            <div class="${compare(character.haki,secretCharacter.haki)}">
        ...
        <td>
            ...
            <div class="${compare(character.bounty,secretCharacter.bounty)}">
        ...
        <td>
            ...
            <div class="${compare(character.height,secretCharacter.height)}">
...
function showHint(){
    ...
    alert("All hints have been unlocked.");
...
console.log("One Piece Engine Loaded");
