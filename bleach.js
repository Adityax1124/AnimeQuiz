...
function setBleachStat(key,value){
...
function addBleachGuess(){

    setBleachStat(

        "bleach_total_guesses",
...
function updateBleachBestStreak(current){
...
console.log("Bleach Story Ready");
...
async function submitGuess(){
    ...
    row.innerHTML = `
        ...
        <td>
            ${numberDisplay(character.height,secretCharacter.height)}
        </td>

        <td>
            <div class="${compare(character.hairColor,secretCharacter.hairColor)}">
                ${character.hairColor}
            </div>
        </td>

        <td>
            <div class="${compare(character.location,secretCharacter.location)}">
                ${character.location}
            </div>
        </td>
...
console.log("Bleach Engine Loaded");
